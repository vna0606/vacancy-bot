...
01-bot/
  ...
  handlers/
    ...
    scam_safety.py         — кнопка «⚠️ Про мошенников»: ссылка на статью о безопасности
  announce_scam_safety.py  — разовая рассылка статьи с обновлённым главным меню
  systemd/                 — одноразовые unit-файлы запланированной рассылки статьи
